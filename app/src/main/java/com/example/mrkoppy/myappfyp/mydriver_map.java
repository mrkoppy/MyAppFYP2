...
public class mydriver_map extends FragmentActivity implements OnMapReadyCallback {
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        LatLng cyberjaya = new LatLng(-2.921318, 101.655935);
        mMap.addMarker(new MarkerOptions().position(cyberjaya).title("Marker in Sydney"));
        mMap.moveCamera(CameraUpdateFactory.newLatLng(cyberjaya));
    }
